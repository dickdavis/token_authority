...
# Confidential Client OAuth Flow with PKCE and Redirect URI
#
# This script demonstrates the full OAuth flow for a confidential client,
# including all optional parameters (PKCE and redirect_uri).
#
# Prerequisites:
...
#
# Usage:
#   rails runner script/confidential_client_full.rb
...
section "Confidential Client OAuth Flow with PKCE and Redirect URI"
...
puts "PKCE provides additional security even for confidential clients."
puts
...
puts
puts "For CONFIDENTIAL clients with PKCE:"
...
puts "  - redirect_uri must match the authorization request"
puts
